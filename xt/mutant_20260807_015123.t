...
# --- SURVIVOR: BOOL_NEGATE_289_2 (MEDIUM) line 289 in can() ---
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_289_2 line 289 in can()';
    # NOTE: new() called with no arguments as a starting point.
    # If Class::Simple::Cached requires constructor arguments, add them here.
    my $obj = new_ok('Class::Simple::Cached');
    # TODO: exercise line 289 in can() to detect the mutant
    fail('BOOL_NEGATE_289_2: replace with real assertion');
}

# --- LOW DIFFICULTY HINTS (comment stubs) ---

# --- LOW HINT: RETURN_UNDEF_289_2 line 289 in can() ---
