...
# Source:  # When called as a class method there is no wrapped object to interrogate
...
# Source:  # Blessed object returned from the wrapped object — return as-is
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
